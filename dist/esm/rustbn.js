 ...
 * @returns {string}
 */
export const ec_mul = function (input_hex) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export const ec_add = function (input_str) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
export const ec_pairing = function (input_str) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
const wasmInstance = await WebAssembly.instantiate(await WebAssembly.compile(base64.decode(wasmB64.wasm)), imports);
